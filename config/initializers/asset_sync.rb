if defined?(AssetSync)
  AssetSync.configure do |config|
    ...
    config.aws_access_key_id = Rails.application.credentials.dig(:s3, :access_key_id)
    config.aws_secret_access_key = Rails.application.credentials.dig(:s3, :secret_access_key)
